...
date: '2026-09-10'
category: regulation
title: A UK commission wants medical AI regulated as it changes, not just approved once
dek: >-
  After a year-long review and evidence from more than 12,000 people, a
  commission chaired by NHS doctors proposes replacing one-time device
  approval with staged authorization and continuous real-world monitoring.
sources:
  - label: >-
      Independent commission led by NHS doctors sets out blueprint to
      accelerate safe AI adoption in healthcare — GOV.UK (official)
    url: >-
