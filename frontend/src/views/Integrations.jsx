...
const INTEGRATIONS = [
  ...
  },
  {
    ...
    desc: "Not yet connected -- no SCIM protocol integration exists yet. Provision people manually from the Team page in the meantime; that's the same IdentityMapping table a real SCIM sync would write into.",
  },
  {
